...
require_once 'src/database.php'; // Importa suas funções de consulta
...
<body class="container">
    <nav>
        ...
        <ul>
            ...
            <li><a href="pages/cadastro.php">Cadastrar Nova</a></li>
        </ul>
    </nav>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="acoes">
                        ...
                        <a href="pages/editar.php?id=<?= $f['id'] ?>">Editar</a> | 
                        <a href="actions/excluir.php?id=<?= $f['id'] ?>" style="color:red" onclick="return confirm('Excluir esta ferramenta?')">Excluir</a>
                    </td>
                </tr>
